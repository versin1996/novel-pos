...
(function(global, factory) {
    ...
    var isFunction = function isFunction(obj) {
        ...
        return typeof obj === "function" && typeof obj.nodeType !==
            "number";
    };
            ...
            setDocument = Sizzle.setDocument = function(node) {
                ...
                if ((support.qsa = rnative.test(document.querySelectorAll))) {
                    ...
                    assert(function(el) {
                        ...
                        docElem.appendChild(el).disabled =
                            true;
    ...
    jQuery.extend({
        ...
        when: function(singleValue) {
            ...
            if (remaining <= 1) {
                adoptValue(singleValue, master.done(updateFunc(
                        i)).resolve, master.reject, !
                    remaining);
    ...
    function setGlobalEval(elems, refElements) {
        ...
        for (; i < l; i++) {
            dataPriv.set(
                elems[i],
                "globalEval", !refElements || dataPriv.get(refElements[
                    i], "globalEval")
            );
        }
    }
        ...
        dispatch: function(nativeEvent) {
            ...
            while ((matched = handlerQueue[i++]) && !event.isPropagationStopped()) {
                ...
                while ((handleObj = matched.handlers[j++]) &&
                    ...
                    if (!event.rnamespace || handleObj.namespace ===
                        false ||
                ...
                if (hasScripts) {
                    ...
                    for (i = 0; i < hasScripts; i++) {
                        ...
                        if (rscriptType.test(node.type || "") &&
                            ...
                            if (node.src && (node.type || "").toLowerCase() !==
                                "module") {
    ...
    (function() {
        ...
        function computeStyleTests() {
            ...
            scrollboxSizeVal = roundPixelMeasures(div.offsetWidth / 3) ===
                12;
    ...
    function getWidthOrHeight(elem, dimension, extra) {
        ...
        if ((!support.boxSizingReliable() && isBorderBox ||
                val === "auto" ||
                !parseFloat(val) && jQuery.css(elem, "display", false,
                    styles) === "inline") &&
        ...
        jQuery.cssHooks[dimension] = {
            get: function(elem, computed, extra) {
                if (computed) {
                    ...
                    return rdisplayswap.test(jQuery.css(
                        ...
                        getWidthOrHeight(elem, dimension,
                            extra);
                }
            },
            ...
            set: function(elem, value, extra) {
                var matches,
                    ...
                    boxSizingNeeded = scrollboxSizeBuggy ||
                    extra,
                    isBorderBox = boxSizingNeeded &&
                ...
                if (subtract && (matches = rcssNum.exec(
                        value)) &&
                    (matches[3] || "px") !== "px") {
    ...
    jQuery.Animation = jQuery.extend(Animation, {
        ...
        tweeners: {
            "*": [function(prop, value) {
                ...
                adjustCSS(tween.elem, prop, rcssNum.exec(
                    value), tween);
                return tween;
            }]
        },
    ...
    jQuery.fn.extend({
        fadeTo: function(speed, to, easing, callback) {
            ...
            return this.filter(isHiddenWithinTree).css(
                "opacity", 0).show()
    ...
    jQuery.fn.extend({
        ...
        toggleClass: function(value, stateVal) {
            var type = typeof value,
                isValidValue = type === "string" || Array.isArray(
                    value);
            ...
            select: {
                ...
                set: function(elem, value) {
                    ...
                    while (i--) {
                        ...
                        if (option.selected =
                            jQuery.inArray(jQuery.valHooks.option
                                .get(option), values) > -1
                        ) {
                            optionSet = true;
                        }
    ...
    jQuery.extend(jQuery.event, {
        ...
        trigger: function(event, data, elem, onlyHandlers) {
            ...
            if (!onlyHandlers && !special.noBubble && !isWindow(
                    elem)) {
            ...
            if (!onlyHandlers && !event.isDefaultPrevented()) {
                ...
                if ((!special._default ||
                    ...
                    if (ontype && isFunction(elem[type]) && !
                        isWindow(elem)) {
    ...
    jQuery.ajaxPrefilter("json jsonp", function(s, originalSettings, jqXHR) {
        ...
        if (jsonProp || s.dataTypes[0] === "jsonp") {
            ...
            jqXHR.always(function() {
                ...
                if (responseContainer && isFunction(
                        overwritten)) {
